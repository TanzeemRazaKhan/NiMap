<%@ Page Title="Add Employee Detail" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Add-Category .aspx.cs" Inherits="Add_Branch" %>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <label class="col-form-label">
                                        Category Name<asp:RequiredFieldValidator ID="rqtxtlast" Font-Size="9" runat="server" ControlToValidate="txtlast" Text="*" ForeColor="Red" Display="Dynamic" ErrorMessage="Enter Pendency">
                                        </asp:RequiredFieldValidator></label>
                                    <asp:TextBox ID="txtlast" Placeholder=" Category Name" class="form-control" runat="server"></asp:TextBox>
                            ...
                            <div style="text-align: end;">
                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" DisplayMode="BulletList" ShowMessageBox="True" ShowSummary="False" CssClass="validation-summary" />
